...
/**
 * Part a copy of <code>java.io.Bits</code>, which is for unknown reason package
 * local. Utility methods for packing/unpacking primitive values in/out of byte
...
public class Bits {
    ...
    /**
     * Returns value with the bit corresponding to the mask set (if setBit is
     * true) or cleared (if setBit is false).
     */
